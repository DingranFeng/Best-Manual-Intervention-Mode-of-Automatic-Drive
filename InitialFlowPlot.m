...
ylabel('车流密度对数','fontsize',14)
title('不同初始车流密度下的车流密度-时间半对数曲线','fontsize',17)
hold off
...
grid on
xlabel('时间/s','fontsize',14)
ylabel('车流量对数','fontsize',14)
title('不同初始车流密度下的车流量-时间半对数曲线','fontsize',17)
hold off
